...
namespace NetDemo
{
    public static class WebApiHelper
    {
        ...
        /// <returns></returns>
        public static string Post<T>(string url, string data, string token, UploadContentType contentType = UploadContentType.Json)
        {
        ...
        /// <returns></returns>
        public static string Post<T>(string url, NameValueCollection data, List<Tuple<string, string, byte[]>> files, UploadContentType contentType = UploadContentType.File, string token = "")
        {
            Stream reqstream = null;
            StreamReader streamReader = null;
            Stream streamReceive = null;
